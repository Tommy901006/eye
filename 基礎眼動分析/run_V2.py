...
root = tk.Tk()
root.title("檔案管理助手")
root.geometry("700x600")  # 設定視窗大小
root.configure(bg="#2c3e50")

# 標題標籤
title_label = tk.Label(root, text="檔案管理助手", bg="#2c3e50", fg="white", font=("Arial", 20, "bold"))
title_label.pack(pady=20)

# 來源資料夾選擇
source_frame = tk.Frame(root, bg="#34495e")
source_frame.pack(pady=10, fill="x", padx=20)
source_label = tk.Label(source_frame, text="來源資料夾:", bg="#34495e", fg="white", font=("Arial", 12))
source_label.pack(side="left", padx=10)
source_entry = tk.Entry(source_frame, width=50, font=("Arial", 12))
source_entry.pack(side="left", padx=10)
source_button = tk.Button(source_frame, text="選擇", command=select_source_folder, bg="#e74c3c", fg="white", font=("Arial", 12))
source_button.pack(side="left", padx=10)

# 目的地資料夾選擇
dest_frame = tk.Frame(root, bg="#34495e")
dest_frame.pack(pady=10, fill="x", padx=20)
dest_label = tk.Label(dest_frame, text="目的地資料夾:", bg="#34495e", fg="white", font=("Arial", 12))
dest_label.pack(side="left", padx=10)
dest_entry = tk.Entry(dest_frame, width=50, font=("Arial", 12))
dest_entry.pack(side="left", padx=10)
dest_button = tk.Button(dest_frame, text="選擇", command=select_destination_folder, bg="#e74c3c", fg="white", font=("Arial", 12))
dest_button.pack(side="left", padx=10)

# 複製檔案按鈕
copy_button = tk.Button(root, text="複製檔案  Step 1", command=copy_files, bg="#2980b9", fg="white", font=("Arial", 14))
copy_button.pack(pady=10)

# 開始轉換按鈕
convert_button = tk.Button(root, text="開始轉換 Excel  Step 2", command=start_conversion, bg="#2980b9", fg="white", font=("Arial", 14))
convert_button.pack(pady=10)

# 資料確認按鈕
convert_button1 = tk.Button(root, text="資料確認  Step 3", command=check, bg="#2980b9", fg="white", font=("Arial", 14))
convert_button1.pack(pady=10)

# 計算瞳孔直徑按鈕
calculate_button = tk.Button(root, text="計算瞳孔大小統計  Step 4", command=calculate_pupil_diameter_statistics, bg="#2980b9", fg="white", font=("Arial", 14))
calculate_button.pack(pady=10)

# 結果顯示區域
result_frame = tk.Frame(root, bg="#2c3e50")
result_frame.pack(pady=20, fill="both", expand=True, padx=20)
result_text = scrolledtext.ScrolledText(result_frame, height=10, bg="#ecf0f1", font=("Arial", 12))
