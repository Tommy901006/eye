...
output_folder = r'C:\Users\User\Desktop\T\test'
output_excel_path = r'C:\Users\User\Desktop\T\test\post-R50.xlsx'

# Ensure output folder exists
os.makedirs(output_folder, exist_ok=True)

# Step 1: Process all files and calculate CM R50 along with distances to fixed point
